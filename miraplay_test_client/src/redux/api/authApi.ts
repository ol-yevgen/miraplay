...
import { IAccessToken, ILoginRes, ILoginTypes, IRegistrationTypes, IUserPayload, ILogoutRes, IRegRes } from 'types/AuthTypes';
...
export const authApi = createApi({
    ...
    endpoints: (builder) => ({
        registrationUser: builder.mutation<IRegRes, IRegistrationTypes>({
            query(data) {
                return {
